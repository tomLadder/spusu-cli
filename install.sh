...
DOWNLOAD_URL="https://github.com/$REPO/releases/download/$TAG/spusu-$TARGET"

echo "Downloading spusu $TAG for $TARGET..."
TMPFILE="$(mktemp)"
...
echo "spusu $TAG installed successfully! Run 'spusu --help' to get started."
